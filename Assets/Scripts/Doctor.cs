...
public class Doctor : MonoBehaviour, IGoap
{
    NavMeshAgent agent;
	...
	public HashSet<KeyValuePair<string,object>> GetWorldState () 
	{
        ...
        worldData.Add(new KeyValuePair<string, object>("storageFacilityHasResources", (storageFacilityInventory.spaceshipParts > 0 &&
                                                                                       storageFacilityInventory.blueprints > 0 && 
                                                                                       storageFacilityInventory.research > 0)));
